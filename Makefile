...
#    Updated: 2022/06/14 19:11:01 by afonso           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
LIB = ar -rcs
SRCS = so_long.c check_map.c load_game_images.c get_next_line.c get_next_line_utils.c event_handler.c make_window.c player_move.c
OBJS = ${SRCS:.c=.o}
